...
const getDataBinance = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Binance', error);
    return binanceDataArr = [];
  }
...
const getDataKucoin = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Kucoin', error);
    return kucoinDataArr = [];
  }
...
const getDataBybit = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de ByBit', error);
    return bybitDataArr = [];
  }
...
const getDataHuobi = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Huobi', error);
    return huobiDataArr = [];
  }
}
const getDataCryptoDotCom = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de CryptoDotCom', error);
    return cryptoDotComDataArr = [];
  }
}
const getDataGateIo = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Gateio', error);
    return gateIoDataArr = [];
  }
}
const getDataMexc = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Mexc', error);
    return mexcDataArr = [];
  }
}
const getDataLbank = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de LBank', error);
    return lbankDataArr = [];
  }
}
const getDataBitget = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Bitget', error);
    return bitgetDataArr = [];
  }
}
const getDataKraken = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Kraken', error);
    return krakenDataArr = [];
  }
}
const getDataOkx = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Okx', error);
    return okxDataArr = [];
  }
}
const getDataBingx = async (req, res, next) => {
  try {
    ...
    console.error('Error de API Bingx', error);
    return bingxDataArr = [];
  }
}
const getDataBitstamp = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Bitstamp', error);
    return bitstampDataArr = [];
  }
}
const getDataBitmart = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Bitmart', error);
    return bitmartDataArr = [];
  }
}
const getDataDigifinex = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Digifinex', error);
    return digifinexDataArr = [];
  }
}
const getDataTidex = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Tidex', error);
    return tidexDataArr = [];
  }
}
const getDataBigone = async (req, res, next) => {
  try {
    ...
    console.error('Error de API de Bigone', error);
    return bigoneDataArr = [];
  }
}
